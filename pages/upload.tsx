...
const Upload = () => {
  ...
  return (
    <div className="flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#f8f8f8] justify-center">
      <div className="bg-white rounded-lg xl:h-[80vh] w-[80%] flex gap-6 flex-wrap justify-center md:justify-between items-center p-14 pt-6">
        <div>
          <div>
                  ...
                  <label className="cursor-pointer">
                    <div className="flex flex-col items-center justify-center h-full">
                      ...
                      <p className="text-gray-400 text-center mt-10 text-sm leading-10">
                        ...
                        720x120 or higher <br />
                        Up to 10 minutes <br />
                        Less than 2gb
                      </p>
                      <p className="bg-[#f51997] text-center mt-10 rounded text-white text-lg p-2 w-52 outline-none font-medium">
                        Select File
                      </p>
                    </div>
                    <input
